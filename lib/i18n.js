(function() {
  var I18n, assert, findTemplate, get, set, lookupKey,
      EmHandlebars, EmHelper, keyExists;

  EmHandlebars = Ember.Handlebars;
  EmHelper = Ember.Helper;
  get = Ember.get;
  set = Ember.set;
  assert = Ember.assert;
  ...
  findTemplate = function(key) {
    assert("You must provide a translation key string, not " + key, typeof key === 'string');
  ...
  // To create the 't' helper, include this into your 'App' code:
  //
